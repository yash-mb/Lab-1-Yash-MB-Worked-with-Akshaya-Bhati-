...
keys = ["Moving up","Moving down","Moving left","Moving right","\b", Keycode.RETURN,Keycode.UP_ARROW, Keycode.DOWN_ARROW, Keycode.SPACE, "Detector stopped"]
